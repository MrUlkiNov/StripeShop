"""
Django settings for StipeProj project.
...
SECRET_KEY = 'django-insecure-mqy17)v#@+n7xf8n%hf*&cf-c)!qgrb8))04t3&w+6!c_y9_eh'
...
WSGI_APPLICATION = 'StipeProj.wsgi.application'
...
STRIPE_SECRET_KEYS = {
    'rub': os.getenv('STRIPE_SECRET_KEY'),
